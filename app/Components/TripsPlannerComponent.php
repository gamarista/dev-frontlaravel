...
class  TripsPlannerComponent implements ISheetData
{
    ...
    public function getDataTypeBConfirmed($request)
    {
        ...
        $params = [
            ...
            //'tripType' => $request->get('tripType'),
            'tripType' => 'B',
            'confirmTrip' =>  $request->get('confirmTrip') == null ? True : $request->get('confirmTrip'),
            'status' => $request->get('status'),
            'destino' => $request->get('destino'),
            'hora' => $request->get('hora'),
            'horae' => $request->get('horae'),
        ...
        $appoinments = ges_appoinments::getTripsTypeBConfirmed($params, $sort, $centers);
