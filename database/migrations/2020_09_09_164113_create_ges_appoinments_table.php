...
class CreateGesAppoinmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ges_appoinments', function (Blueprint $table) {
           $table->id();
           ...
           $table->string('TripType',5)->nullable();
           $table->timestamps();            
        });
    }
    ...
    {
        Schema::dropIfExists('ges_appoinments');
    }
}
