        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}">FRONT-DESK RETURNS</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{route('frontdeskplanner')}}">Return to be confirmed</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{route('frontdeskplannerconfirmed')}}">Confirmed Trip</a>
                    </li>


                    <li class="nav-item dropdown ">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle mx-auto" href="#" role="button"
