...
<div id="app">
 ...
 <main class="py-4">
   ...
   @endif 	
   @php
     $medicalc = json_decode($medicalc,false);
   @endphp
   ...
   <div class="row">
    ...
    <ul class="nav nav-tabs">
     <li><a href="{{route('wschedule')}}">Day</a></li>
	  ...
	  var date = new Date();
		...
		*/
		...
		select: function(start, end, allDay) {
				...
				var xAct = new Date(dateAct.getFullYear().toString()+'/'+dateAct.getMonth().toString()+'/'+dateAct.getDate().toString());
				var xUsr = new Date(xdateAct.getFullYear().toString()+'/'+xdateAct.getMonth().toString()+'/'+xdateAct.getDate().toString());
				$("#Fecha1").val(xAct); //+dateAct.getMonth()+dateAct.getFullYear());
				$("#xFecha1").val(xUsr); //+xdateAct.getMonth()+xdateAct.getFullYear());
